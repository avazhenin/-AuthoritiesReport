select con.name,
       con.date_of_birth,
       smaster.inv_customer_altel.get_registration_addr(ch.customer_id) registration_addr,
       smaster.inv_customer_altel.get_delivery_addr(ch.customer_id) delivery_addr,
       smaster.inv_customer_altel.get_documents(ch.customer_id) documents,
       con.inn,
       con.contract_num,
	   p.msisdn
  from contract con
